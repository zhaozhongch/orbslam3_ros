...
int main(int argc, char **argv)
{
    ...
    message_filters::Subscriber<sensor_msgs::Image> rgb_sub(nh, "/camera/rgb/image_raw", 100);//"/camera/rgb/image_raw"
    message_filters::Subscriber<sensor_msgs::Image> depth_sub(nh, "/camera/depth_registered/image_raw", 100);//"camera/depth_registered/image_raw"
    message_filters::Subscriber<sensor_msgs::Image> mask_sub(nh, "/camera/mask/image_raw", 100);
